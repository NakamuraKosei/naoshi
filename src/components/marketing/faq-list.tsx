...
const defaultFaqs: FaqItem[] = [
  {
    ...
    a: "日本語特化のAIヒューマナイザーです。AIが書いたレポートを、人が書いたような自然な日本語に書き換えます。",
  },
  {
    q: "AIヒューマナイザーとは何ですか？",
    a: "AIが生成した文章を、人間が書いたような自然な文章に書き換えるツールのことです。Naoshiは日本語のレポートに特化しており、参考文献や固有名詞を改変せず、文の構造・語彙・リズムを書き換えます。",
  },
  {
